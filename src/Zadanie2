/*
 * Zaimplementuj metodę "nwd2" znajdującą największy wspólny dzielnik metodą "poprzez rozkład na czynniki pierwsze", opisaną w:
http://pl.wikipedia.org/wiki/Najwi%C4%99kszy_wsp%C3%B3lny_dzielnik
Podpowiedź: wykorzystaj obiekty klasy ArrayList do pamiętania listy czynników pierwszych. Liczby przechowuj w obiektach klasy Integer.
 */
...
public class Zadanie2 {
		...
		public static void main(String[] args) {
	        ...
	        nwd2(a, b); // Wywołanie metody nwd2
	        sc.close();
		}
        ...
        int y = 0;
        System.out.print("\nRozkład na czynniki pierwsze liczby " + b1 + "=");
        while (y < liczbyPierwszeB.size()) {
            System.out.print(liczbyPierwszeB.get(y) + "*");
            y++;
        }

        ArrayList<Integer> Wspolne = new ArrayList<Integer>();  // Tworzenie wspólnej listy dzielnikow
